...
# os.environ["HF_HOME"] = "your model path"
import numpy as np
import torch
...
class ProgramInterpreter:
    def __init__(self, models_loc, models_vqa):
        self.step_interpreters = register_step_interpreters(models_loc, models_vqa)
...
class ProgramGenerator:
    def __init__(self, model_name_or_path="THUDM/glm-4-9b-hf",
    ...
    def generate(self, inputs, prompter):
        """
