...
class VQAInterpreter():
    ...
    def __init__(self):
        ...
        # If you don't want ensembling, comment self.processor and self.model assignments above and uncomment lines below
...
# uncomment the following if you don't want ensembling
# class LocInterpreter():
#     step_name = 'LOC'
